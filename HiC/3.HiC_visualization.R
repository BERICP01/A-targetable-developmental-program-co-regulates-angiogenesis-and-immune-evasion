...
SKMEL5_loops = read.delim('SKMEL-5_CTCF_merged_loops.bedpe', h = F)
SKMEL5_tads = read.delim('SKMEL-5_40kb.output', h = F)

MEL501_loops = read.delim('501mel_CTCF_merged_loops.bedpe', h = F)
MEL501_tads = read.delim('501mel_40kb.output', h = F)

####Region HOXD13
pdf(file.path(dir, "HiC_pyramid_SKMEL-5_HOXD13.pdf"))
...
pdf(file.path(dir, "HiC_pyramid_501mel_HOXD13.pdf"))
...
pdf(file.path(dir, "HiC_pyramid_SKMEL5_501mel_diff_HOXD13.pdf"))
