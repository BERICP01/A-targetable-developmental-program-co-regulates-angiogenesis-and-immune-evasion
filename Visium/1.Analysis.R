...
# Acral samples
AM3 <- Load10X_Spatial('Visium_outs/AM3/outs', 
                              filename = "filtered_feature_bc_matrix.h5",
                              assay = "Spatial",
                              slice = "tissue_lowres_image.png")
AM3 <- SCTransform(AM3, assay = "Spatial", verbose = FALSE)
AM3@meta.data$sample_ID <- 'AM3'

AM711 <- Load10X_Spatial('Visium_outs/AM711/outs', 
                              filename = "filtered_feature_bc_matrix.h5",
                              assay = "Spatial",
                              slice = "tissue_lowres_image.png")
AM711 <- SCTransform(AM711, assay = "Spatial", verbose = FALSE)
AM711@meta.data$sample_ID <- 'AM711'

met <- merge(AM3, y = c(AM711))
